...
(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["low", "medium", "high"]).range(["#F20C23", "#EBE37C", "#05F519"]);
...
/* 		if (x == "North Carolina")
		{
			...
			var links="</br><a href=\"http://127.0.0.1/laurel/NC%20Readmissions.html\">General Readmission Data </a>";
			div.innerHTML = div.innerHTML + links;		
		} */
		y=convert_state(x,"abbrev");
		x=y;
      ...
      this.data.forEach((function(_this) {
        return function(d) {
          ...
          node = {
            id: d.id,
            radius: _this.radius_scale(parseInt(d.total_amount/10)),
    ...
    BubbleChart.prototype.create_vis = function() {
      ...
      this.circles.enter().append("circle").attr("r", 0).attr("fill", (function(_this) {
        ...
        return that.hide_details(d, i, this);
		  ...
		  var linkvalue="http://127.0.0.1/laurel/"
		  linkvalue = linkvalue+d.state+"%20Readmissions.html";
        return window.location.assign(linkvalue);
      });
    ...
    BubbleChart.prototype.display_years = function() {
      ...
      years_x = {
        "Negative": 160,
        "Neutral": this.width / 2,
        "Positive": this.width - 160
      };
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content += "<span class=\"name\">County:</span><span class=\"value\"> " + data.county + "</span><br/>";
      content += "<span class=\"name\">Rating:</span><span class=\"value\"> " + (addCommas(data.value)) + "/100</span><br/>";
  ...
  $(function() {
    ...
    return d3.csv("data/TEC12.csv", render_vis);
  });
